...
class Repo:
    ...
    def render_refs(self, local: bool = True, remote: bool = False, tags: bool = True, max_width: int | None = None, color: bool = True) -> str: ...
    def render_log(self, rev: str, max_commits: int = 200, decorate: bool = True, graph: bool = True, max_width: int | None = None, color: bool = True) -> str: ...
...
def refs_tui(repo: Repo | PathLikeStr, local: bool = True, remote: bool = False, tags: bool = True, max_width: int | None = None, color: bool = True) -> str: ...
def log_tui(repo: Repo | PathLikeStr, rev: str = "HEAD", max_commits: int = 200, decorate: bool = True, graph: bool = True, max_width: int | None = None, color: bool = True) -> str: ...
def log_graph(repo: Repo | PathLikeStr, refs: list[str] | None = None, max_commits: int = 400, decorate: bool = True, max_width: int | None = None, color: bool = True) -> str: ...
